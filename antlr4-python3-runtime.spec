...
%prep
%setup -q -n antlr4-python3-runtime-4.11.1
cd %{_builddir}/antlr4-python3-runtime-4.11.1
pushd ..
cp -a antlr4-python3-runtime-4.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662388777
